  ...
  public IntakeCone(Intake m_intake, Wrist m_wrist, Arm m_arm) {
    addCommands(
        ...
        new ParallelCommandGroup(
            new Collection(m_intake, -1, 0.75).withTimeout(3), new MoveWristToAngle(m_wrist, -90)),
        new MoveArm(m_arm, 1, 0.75).withTimeout(2),
        new ParallelCommandGroup(
            new Collection(m_intake, 1, 0.75).withTimeout(3), new MoveWristToAngle(m_wrist, -5)),
