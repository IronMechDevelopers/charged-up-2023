...
public class Wrist extends SubsystemBase {
  ...
  private final WPI_TalonSRX wristMotor =
      new WPI_TalonSRX(Constants.WRIST_MOTOR_CONTROLLER_CONSTANT);
  ...
  public void setTalon(final WPI_TalonSRX _talon) {
    ...
    _talon.config_kF(Constants.kSlotIdx, Constants.kGains_wrist_kF, Constants.kTimeoutMs);
    _talon.config_kP(Constants.kSlotIdx, Constants.kGains_wrist_kP, Constants.kTimeoutMs);
    _talon.config_kI(Constants.kSlotIdx, Constants.kGains_wrist_kI, Constants.kTimeoutMs);
    _talon.config_kD(Constants.kSlotIdx, Constants.kGains_wrist_kD, Constants.kTimeoutMs);
