...
public class RobotContainer {
  ...
  public static final Auto_Selector autoSelector =
      new Auto_Selector(driverLeftStick, driverRightStick);
  ...
  public RobotContainer() {
    m_drivetrain.setDefaultCommand(
        new Drive(driverLeftStick::getY, driverRightStick::getX, m_drivetrain));
  ...
  private void configureBindings() {
    ...
    aButton.whileTrue(
        new Collection(m_intake, CONE_COLLECTION_IN_DITRECTION, CONE_COLLECTION_OUT_SPEED));
    bButton.whileTrue(
        new Collection(m_intake, CONE_COLLECTION_OUT_DITRECTION, CONE_COLLECTION_IN_SPEED));
    ...
    rightTwo.toggleOnTrue(
        new SlowSpeed(driverLeftStick::getY, driverRightStick::getX, m_drivetrain));

    leftTen.toggleOnTrue(
        new AutoLevelThreeCone(m_drivetrain, m_arm, m_wrist, m_intake)
            .andThen(new AutoDriveBackwards(m_drivetrain, m_wrist)));

    rightTen.toggleOnTrue(
        new AutoLevelThreeCone(m_drivetrain, m_arm, m_wrist, m_intake)
            .andThen(new AutoDriveBackwards(m_drivetrain, m_wrist)));
  }
